...
function buildSandbox() {
  ...
  const els = [
    ...
    "endPanel","endTitle","endText","restartBtn","pauseBtn","ultBtn","joystick","stick",
  ];
...
async function loadGame() {
  ...
  script = script.replace(
    ...
    `requestAnimationFrame(loop);window.__T__={state,player,update,levelUp,collectGems,finishLevelChoice,chooseOption,getLevelOptions,randomNormalOptions,updateWeaponName,togglePause,keys,startNewRun,debugJumpToNextNode,levelPanel,levelOptions};})();`,
  );
